...
public class Tab_ChayTrang extends Fragment implements TabHost.OnTabChangeListener, ViewPager.OnPageChangeListener {
    ...
    private void initializeTabHost(Bundle paramBundle) {
        ...
        tabHost.setup();
        TabHost.TabSpec tabSpec = this.tabHost.newTabSpec("ChTrang");
        tabSpec.setIndicator("Vtrang");
        tabSpec.setContent(new FakeContent((Context)getActivity()));
        this.tabHost.addTab(tabSpec);
        tabSpec = this.tabHost.newTabSpec("Mch);
                tabSpec.setIndicator("Tkho);
                        tabSpec.setContent(new FakeContent((Context)getActivity()));
        this.tabHost.addTab(tabSpec);
    ...
    private void initializeViewPager() {
        Vector<Frag_Chaytrang> vector = new Vector();
        vector.add(new Frag_Chaytrang());
        vector.add(new Frag_ChayTrang_Acc());
